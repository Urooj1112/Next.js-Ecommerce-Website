  ...
  return (
    <div className="flex flex-col items-start gap-4 w-[270px] h-[350px] rounded-lg relative shrink-0">
      ...
      <div className="flex flex-col relative w-[270px] h-[250px] bg-[#F5F5F5]">
        ...
        />
        <div className="bg-black w-full h-[41px] text-white text-[16px] font-medium rounded-br-sm rounded-bl-sm flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
          Add To Cart
        </div>
      </div>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <span className="font-medium text-[16px] text-[#DB4444]">
